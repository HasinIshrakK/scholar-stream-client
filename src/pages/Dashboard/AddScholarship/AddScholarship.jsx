...
const AddScholarship = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: "Scholarship has been successfully created",
            });
            ...
            Swal.fire({
                icon: "error",
                title: "Failed",
                text: "Could not add scholarship",
            });
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-base-100 shadow rounded-lg">
            <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: "'Fraunces', serif" }}>Add New Scholarship</h2>
