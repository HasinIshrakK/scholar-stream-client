        ...
        <div className="hero py-6 min-h-screen">
            <div className="hero-content flex-col">
                <div className="text-center">
                    <h1 className="text-5xl text-indigo-700 font-bold">Register now!</h1>
                    <p className="py-6">
                ...
                <div className="card bg-base-100 w-full sm:w-96 max-w-sm shrink-0 shadow-2xl">
                    <div className="card-body">
                        <form>
                            ...
                            <button className="btn btn-primary btn-outline bg-white text-black border-[#e5e5e5] mt-2 w-full">
